...
writeJson(path.join(projectRoot, "package.json"), { name: "topogram-generator-sqlite-db-consumer", private: true, type: "module", devDependencies: { "@attebury/topogram": cliDependencySpec, "@attebury/topogram-generator-sqlite-db": `file:${generatorTarball}` } });
